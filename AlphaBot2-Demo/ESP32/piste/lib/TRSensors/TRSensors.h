...
#define TEMPO_SPI 5 //en microsecondes
...
class TRSensors
{
  ...
  TRSensors();
	...
	void AnalogRead(unsigned int *sensor_values);
        ...
        // same function but with SPI transfert
        void AnalogReadSPI(unsigned int *sensor_values);
  ...
  unsigned char _numSensors;
	...
	unsigned int *calibratedMax;
        unsigned int Nbat;  //valeur de l'ADC pour la mesure de la batterie
