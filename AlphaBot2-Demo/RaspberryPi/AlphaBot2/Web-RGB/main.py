...
def index():
    ...
    rgb = 0xffffff
    light_type = 'static'
    return static_file('index.html', '/home/pi/AlphaBot2-Demo/RaspberryPi/AlphaBot2/Web-RGB')

#网页上的静态文件需要做传输处理
@route('/<filename>')
def server_static(filename):
    return static_file(filename, root='/home/pi/AlphaBot2-Demo/RaspberryPi/AlphaBot2/Web-RGB')
